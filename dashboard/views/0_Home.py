...
nav_cards = [
    ("views/1_Executive.py", "\U0001f3af", "Executive", "EAL, VaR, loss exceedance curve, top risk contributors."),
    ("views/2_Technical.py", "\U0001f527", "Technical", "Finding & asset inventory, remediation backlog, ageing."),
    ("views/3_What_if.py", "\U0001f39b️", "What-if", "Slide control coverage and see ΔEAL re-simulate live."),
    ("views/4_Investment.py", "\U0001f4b0", "Investment", "Knapsack-optimized control spend under a ₹ budget."),
    ("views/5_Compliance.py", "✅", "Compliance", "NIST CSF status, incident-clock, ₹-at-risk per control."),
]
